...
<button {onclick} class="card {card.flipped ? "flipped" : ""} {card.flipping ? "scale-110" : ""} aspect-[287/400] h-56 -mb-60 transition-transform duration-300 shadow-md {card.selected ? "translate-y-80" : ""}">
